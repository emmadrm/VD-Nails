...
function Terms() {
    ...
    return (
      ...
      <div className="legal-card">
        ...
        <h3>{t('legal.terms.businessTitle')}</h3>
        <p dangerouslySetInnerHTML={{ __html: t('legal.terms.businessBody') }} />
        ...
        <h3>{t('legal.terms.governingLawTitle')}</h3>
        <p dangerouslySetInnerHTML={{ __html: t('legal.terms.governingLawBody') }} />
