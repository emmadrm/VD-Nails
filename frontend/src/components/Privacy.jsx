...
function Privacy() {
    ...
    return (
      ...
      <div className="legal-card">
        ...
        <h3>{t('legal.privacy.controllerTitle')}</h3>
        <p dangerouslySetInnerHTML={{ __html: t('legal.privacy.controllerBody') }} />
        ...
        <ul>
          ...
          <li dangerouslySetInnerHTML={{ __html: t('legal.privacy.s3Li3') }} />
        </ul>
        ...
        <ul>
          <li dangerouslySetInnerHTML={{ __html: t('legal.privacy.s5Li1') }} />
          <li dangerouslySetInnerHTML={{ __html: t('legal.privacy.s5Li2') }} />
          <li dangerouslySetInnerHTML={{ __html: t('legal.privacy.s5Li3') }} />
          <li dangerouslySetInnerHTML={{ __html: t('legal.privacy.s5Li4') }} />
          <li dangerouslySetInnerHTML={{ __html: t('legal.privacy.s5Li5') }} />
          <li dangerouslySetInnerHTML={{ __html: t('legal.privacy.s5Li6') }} />
        </ul>
        <p dangerouslySetInnerHTML={{ __html: t('legal.privacy.s5Note') }} />

        <h3>{t('legal.privacy.retentionTitle')}</h3>
