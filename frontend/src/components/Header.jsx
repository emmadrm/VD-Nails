      ...
      <header className="py-3 mb-4 border-bottom position-relative">
        ...
        <div className="d-flex justify-content-between align-items-center w-100 px-3 px-md-5">
          ...
          <ul className="d-flex justify-content-center align-items-center gap-3 gap-md-5 premium-menu mx-auto mb-0 ps-0" style={{ listStyle: 'none', flexWrap: 'wrap' }}>
            <li>
              <NavLink to="/" end className={({ isActive }) => `premium-nav-link text-decoration-none text-dark${isActive ? ' active' : ''}`}>{t('header.navHome')}</NavLink>
            </li>
            <li className="services-nav-item">
              <NavLink to="/services" className={({ isActive }) => `premium-nav-link text-decoration-none text-dark${isActive ? ' active' : ''}`}>{t('header.navServices')}</NavLink>
            ...
            <li className="services-nav-item">
              <NavLink to="/eshop" className={({ isActive }) => `premium-nav-link text-decoration-none text-dark${isActive ? ' active' : ''}`}>{t('header.navEshop')}</NavLink>
            ...
            <li>
              <NavLink to="/contact" className={({ isActive }) => `premium-nav-link text-decoration-none text-dark${isActive ? ' active' : ''}`}>{t('header.navFindUs')}</NavLink>
            </li>
            <li>
          ...
          <div className="d-flex gap-3 align-items-center justify-content-end" style={{ flex: 1 }}>
            ...
            {/* ΘΕΣΗ ΓΙΑ DESKTOP */}
            <div className="d-none d-md-flex flex-column align-items-end gap-2">
              {languageSwitcher}
              {userAuthContent}
            </div>
